...
export interface Message {
  ...
  ionization_energies: Array<number>;
  xpos: number;
  ypos: number;
  shells: Array<number>;
...
export class DataService {
  ...
  },
  {
      ...
      "spectral_img": "https://upload.wikimedia.org/wikipedia/commons/3/37/Americium_spectrum_visible.png",
  ...
  public getMessageById(number: number): Message {
    let message:Message;
